<h2><a href="https://www.geeksforgeeks.org/problems/sort-the-array0055/1?page=6&sortBy=latest">Sort The Array</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a random array&nbsp;<strong>arr</strong>&nbsp;of numbers, please return them in ascending sorted order.</span></p>
